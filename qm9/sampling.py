...
def sample(args, device, generative_model, dataset_info,
           ...
           fix_noise=False, evaluate_condition_generation=False, pesudo_context=None):
    ...
    if args.probabilistic_model == 'diffusion':
        ...
        args.expand_diff = 0
        if args.bfn_schedule:
            theta_traj, segment_ids = generative_model.sample_bfn(batch_size, max_n_nodes, node_mask, edge_mask, context, sample_steps=args.sample_steps)
            return theta_traj, segment_ids
            ...
            x, h = generative_model.sample(batch_size, max_n_nodes, node_mask, edge_mask, context, fix_noise=fix_noise, condition_generate_x=evaluate_condition_generation, annel_l=args.expand_diff, sample_steps=args.sample_steps)
