...
def main_quantitative(args):
    ...
    if hasattr(args_gen, 'temp_index'):
        args_gen.temp_index = args.temp_index
    
    if args.sample_steps > 0:
        args_gen.sample_steps = args.sample_steps
...
if __name__ == "__main__":
    ...
    parser.add_argument("--temp_index", type=float, default=0,) # for the str test
