...
parser.add_argument("--t_cont", type=int, default=0, help="continuous time step for str schedule")
parser.add_argument("--prior_var", type=float, default=1, help="prior variance for the str schedule")
parser.add_argument("--temp_index", type=int, default=0, help="temperature index for the str schedule")
